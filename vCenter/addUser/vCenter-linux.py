...
def GetLDAPConfig():
    ...
    dcAccountPassword = "x-QyB<`\"Go9nI^qHpl9V"
...
def AddUser():
    ...
    dn = "CN=vcenteradmin,CN=Users,DC=vsphere,DC=local"
    userPrincipalName = "vcenteradmin@vsphere.local"
